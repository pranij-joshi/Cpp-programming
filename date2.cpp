...
{
    //for year
    //condition if the input year is less than 1
    while(year < 1)
    {
        cout << endl;
    ...
    //valid data is assigned to the members of the Date class.
    Date::day = day;
    Date::month = month;
    Date::year = year;
}
...
void Date::setDay(int d)
{
    ...
    {
        //condition if the day is not between 1-30.
        if(d < 1 || d > 30)
        {
            //while loop runs if and until the correct value is provided.
            while(d > 30 || d < 1)
    ...
    else
    {
        ...
        if(((year % 4 == 0) && (year % 100 != 0)) || (year % 400 == 0))
        {
            //condition if the day is not between 1-29.
            if(d < 1 || d > 29)
            {
                //while loop runs if and until the correct value is provided.
                while(d > 29 || d < 1)
        ...
        {
            //condition if the day is not between 1-28.
            if(d < 1 || d > 28)
            {
                //while loop runs if and until the correct value is provided.
                while(d > 28 || d < 1)
...
void Date::setMonth(int m)
{
    ...
    //condition if the month is not between 1-12.
    if(m < 1 || m > 12)
    {
        //while loop runs if and until the correct value is provided.
        while(m > 12 || m < 1)
...
//the date in three different formats.
//************************************************************
...
int main()
{
    ...
    while(tolower(again) == 'y')
    {
        ...
        cout << "\n\t'6' to subtract the date with a smaller date and display the days between them.\n\n";
        ...
        {
            case 1:
                cout << d1 << endl; //displays the date.
                cout << "*****************************************************************************************" << endl;
                break;

            case 2:
                ++d1; //date increment with prefix ++ operator.
                cout << "The date after increment is:" << endl;
                cout << d1 << endl; //displays the date.
                cout << "*****************************************************************************************" << endl;
                break;
            ...
            case 4:
                ...
                cout << "The date after decrement is:" << endl;
                cout << d1 << endl; //displays the date.
                cout << "*****************************************************************************************" << endl;
                break;
            ...
            case 6:
                cout << "Enter a smaller date: " << endl;
                d2.setDate(); // asks the user for a second date.
                cout << "The difference between " << d1.getDay() << "/" << d1.getMonth() << "/" << d1.getYear();
                cout << " and " << d2.getDay() << "/" << d2.getMonth() << "/" << d2.getYear() << " in days is:\n";
                cout << d1-d2 << endl << endl; //displays the days in between the dates.
                cout << "*****************************************************************************************" << endl;
                break;
