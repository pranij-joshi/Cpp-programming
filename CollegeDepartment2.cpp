...
-displays the object with least and most number
 of courses.
//@author Pranij Joshi
...
int main()
{
    ...
    //creating an small and large obect
    //stores the object with least courses and most courses.
    CollegeDepartment small, large;

    //initializing small object to c[0] object
    small = c[0];
    //initializing small object to c[0] object
    large = c[0];

    //for loop to check for least and most coureses
    for(int i = 0; i < 4; i++)
    {
        if(c[i] < small)
        {
    ...
    cout << "The department with the least number of courses is: " << endl;
    cout << small;
    cout << "***********************************************" << endl;
    cout << "***********************************************" << endl;
    cout << "The department with the most number of courses is: " << endl;
    cout << large;
    cout << "***********************************************" << endl;
    cout << "***********************************************" << endl;
